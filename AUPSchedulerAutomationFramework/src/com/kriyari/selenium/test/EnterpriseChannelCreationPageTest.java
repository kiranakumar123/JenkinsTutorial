...
import com.kriyari.selenium.data.EnterpriseChannelCreationPage;
...
public class EnterpriseChannelCreationPageTest {
	...
	private static EnterpriseChannelCreationPage enterpriseChannelCreationPage;
...
//			}			
	...
	*/
	...
	public static void initiateSeleniumServer() throws IOException{
		...
		enterpriseChannelCreationPage=new EnterpriseChannelCreationPage(selenium);
		enterpriseChannelCreationPage.loadPropertiesFile();
	...
	public void createNewChannel(){
		...
		enterpriseChannelCreationPage.loginToEnterpriseAdminFromNewzstandAdmin();
		enterpriseChannelCreationPage.openChannelsPage();
		enterpriseChannelCreationPage.typeChannelName();
		enterpriseChannelCreationPage.openNewChannelPrompt();
	
		//assertEquals("Please enter the name of the new Channel:-", enterpriseChannelCreationPage.readNewChannelPromptMsg());
	...
	public void createNewTopic() throws InterruptedException{
		...
		enterpriseChannelCreationPage.typeTopicName();
		enterpriseChannelCreationPage.openNewTopicPrompt();
		
		//assertEquals("Please enter the name of the new Topic:-", enterpriseChannelCreationPage.readNewTopicPromptMsg());
